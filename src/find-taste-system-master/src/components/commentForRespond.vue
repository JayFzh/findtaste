  ...
  <div class="commentContainer">
    ...
    <div class="comment-right">
      <div>
        ...
        <el-button v-if="isShow" @click.stop="accept"  style="margin-left: 10px;margin-right: 5px;margin-top: 5px">接受</el-button>
        <el-button v-if="isShow" @click.stop="reject"  style="margin-right: 10px;margin-top: 5px">拒绝</el-button>
      </div>
...
<script>
import {acceptRespond, deleteRespond} from "@/utils/api";
